...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout.addWidget(self.generatingButton)
        ...
        self.verticalLayout.addWidget(self.fractalWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.generatingButton.setText(QCoreApplication.translate("MainWindow", u"Generuj", None))
        self.fractalWindow.setText("")
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Opcje", None))
    # retranslateUi
